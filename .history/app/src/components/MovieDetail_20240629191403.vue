    ...
    <v-card v-if="movie">
      <v-row>
        <v-col cols="12" class="background-container d-flex">
          <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v20.0&appId=973607627550804" nonce="mE9yY0Qh"></script>
