...
.v-img {
  opacity: 1 !important; /* Ensure image opacity is 1 */
  filter: none !important; /* Remove any filters applied by themes */
}

/* Theme specific styles */
.theme--light .background,
.theme--light .v-img {
  opacity: 0.7 !important; /* Set opacity for background in light theme */
  filter: none !important; /* Ensure no filter is applied in light theme */
}

.theme--dark .background,
.theme--dark .v-img {
  opacity: 0.7 !important; /* Set opacity for background in dark theme */
  filter: none !important; /* Ensure no filter is applied in dark theme */
}
</style>
