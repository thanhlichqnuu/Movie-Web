...
<template>
  ...
  <v-btn v-show="$i18n.locale == 'EN'" @click="$i18n.locale = 'VI'"><img class="mr-1" src="../assets/flag_vi.png" height="20px" width="20px"/>VI</v-btn>  
  <v-btn v-show="$i18n.locale == 'VI'" @click="$i18n.locale = 'EN'"><img class="mr-1" src="../assets/flag_en.png" height="20px" width="20px"/>EN</v-btn>
    </v-app-bar>
