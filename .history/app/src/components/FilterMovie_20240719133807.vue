...
const categoryOptions = [
  ...
  { value: 'hoat-hinh', text: t('animation') },
  { value: 'hanh-dong', text: t('action') },
  { value: 'am-nhac', text: t('musical') },
  { value: 'bi-an', text: t('mystery') },
  { value: 'kinh-di', text: t('horror') },
  { value: 'kich-tinh', text: t('thriller') },
  ...
  { value: 'tv-show', text: t('tvShow') },
  { value: 'thieu-nhi', text: t('children') },
  { value: 'tam-ly', text: t('psychology') },
  { value: 'chien-tranh', text: t('war') },
  { value: 'hai-huoc', text: t('comedy') },
  { value: 'kinh-di', text: t('horror') },
