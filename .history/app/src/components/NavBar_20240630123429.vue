      ...
      <v-menu offset-y>
        <template v-slot:activator="{ on, attrs }">
          <v-btn icon v-bind="attrs" v-on="on">
            <img :src="currentLanguage === 'VI' ? '../assets/flag_vi.png' : '../assets/flag_en.png'" alt="flag"  />
        ...
        <v-list>
          <v-list-item @click="changeLanguage('EN')">
            <v-list-item-title>
              <img src="../assets/flag_en.png" alt="English Flag"  />
              English
            </v-list-item-title>
          </v-list-item>
          <v-list-item @click="changeLanguage('VI')">
            <v-list-item-title>
              <img src="../assets/flag_vi.png" alt="Vietnamese Flag"  />
              Tiếng Việt
            </v-list-item-title>
          </v-list-item>
        </v-list>
