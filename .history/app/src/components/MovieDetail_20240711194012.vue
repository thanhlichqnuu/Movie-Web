...
const TrailerModal = defineAsyncComponent(() => import('@/components/TrailerModal.vue'));
...
const { data } = useSWRV(
  () => `https://ophim1.com/phim/${route.params.slugMovie}`,
  fetcher,
  {
...
const episodeAvailable = computed(() => movie.value.episodes[0].server_data[0].slug);
...
<template>
  <v-container>
    <v-card v-if="movie">
      ...
      <v-row>
        <v-col cols="12">
            <v-row :class="{ 'd-flex align-center flex-column': isSmallTabletAndMobile }">
              <v-col cols="12" sm="6">
                <v-list-item>
                  <v-row align="center">
  <v-col cols="4" class="d-flex justify-end">
    <v-list-item-title class="text-size">{{ $t("newEpisode") }}</v-list-item-title>
  </v-col>
  <v-col v-for="episode in movie.episodes[0].server_data.slice(-3)" :key="episode.slug" cols="2" class="d-flex">
    <v-btn @click="loadMovie" size="small">{{ episode.name }}</v-btn>
  </v-col>
</v-row>
                ...
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("status") }}</v-list-item-title>
                    </v-col>
                ...
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("time") }}</v-list-item-title>
                    </v-col>
                    <v-col cols="8" class="d-flex">
                      <v-list-item-subtitle class="text-size">{{
                        movie.movie.time
                ...
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("category") }}</v-list-item-title>
                    </v-col>
                    <v-col cols="8" class="d-flex">
                      <v-list-item-subtitle class="text-size">
                        <span
                ...
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("director") }}</v-list-item-title>
                    </v-col>
                    <v-col cols="8" class="d-flex">
                      <v-list-item-subtitle class="text-size">
                        <span
              ...
              <v-col cols="12" sm="6">
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("country") }}</v-list-item-title>
                    </v-col>
                    <v-col cols="8" class="d-flex">
                      <v-list-item-subtitle class="text-size">
                        <span
                ...
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("quality") }}</v-list-item-title>
                    </v-col>
                    <v-col cols="8" class="d-flex">
                      <v-list-item-subtitle class="text-size">{{
                        movie.movie.quality
                ...
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("releaseYear") }}</v-list-item-title>
                    </v-col>
                    <v-col cols="8" class="d-flex">
                      <v-list-item-subtitle class="text-size">{{
                        movie.movie.year
                ...
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("subtitle") }}</v-list-item-title>
                    </v-col>
                    <v-col cols="8" class="d-flex">
                      <v-list-item-subtitle class="text-size">{{
                        movie.movie.lang
