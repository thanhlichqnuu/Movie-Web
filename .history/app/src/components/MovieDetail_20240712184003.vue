...
const fetcher = async (url) => {
  try {
    ...
    data.movie.content = data.movie.content.replace(/(<([^>]+)>)/ig, "");
    return data;
  } catch {
      ...
      <v-row>
        <v-col cols="12" class="background-container d-flex">
          ...
          <template v-if="!isSmallTabletAndMobile">
            ...
            <v-col cols="6" sm="4" class="d-flex justify-center align-center flex-column-reserve">
              <slot name="fblikediv"></slot>
