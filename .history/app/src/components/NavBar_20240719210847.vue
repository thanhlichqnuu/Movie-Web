...
const isOnSectionMovie = computed(() => route.name === 'Home')
const isOnMovieDetail = computed(() => route.name === 'Detail')
const isOnPlayerModal = computed(() => route.name === 'Player')
</script>
...
<template>
  <div>
    ...
    <v-navigation-drawer v-model="isShowDotMenu" app temporary>
      ...
      <v-list-item v-if="!isOnSectionMovie || !isOnMovieDetail || !isOnPlayerModal" @click="openFilterModal">
