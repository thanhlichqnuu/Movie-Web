...
<template>
  ...
  :sm="isSmallTabletAndMobile ? 12 : 4"
  class="d-flex"
  :class="isSmallTabletAndMobile ? 'flex-column' : 'justify-center align-center'"
>
  <v-img 
    :src="movie.movie.thumb_url" 
    :height="isSmallTabletAndMobile ? '300px' : '70%'" 
    :class="isSmallTabletAndMobile ? 'mb-3' : ''" 
  />
  <v-col
    :cols="isSmallTabletAndMobile ? 12 : 6"
    :sm="isSmallTabletAndMobile ? 12 : 8"
    class="d-flex flex-column justify-space-between"
  >
    <div class="mt-11">
      <v-card-title :class="isSmallTabletAndMobile ? 'text_green text-h5' : 'text_green text-h5'">{{
        movie.movie.name
      }}</v-card-title>
      <v-card-title :class="isSmallTabletAndMobile ? 'text-subtitle-1 mt-n3' : 'mt-n3'" style="font-size: 16px">{{
    ...
    <v-card-action :class="isSmallTabletAndMobile ? 'd-flex ml-4' : 'mb-15 ml-4'">
      <v-btn
