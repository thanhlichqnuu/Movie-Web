      ...
      <v-row>
        <v-col cols="12" class="background-container d-flex">
          ...
          >
            ...
            <v-card-title class="text-subtitle-1">{{ movie.movie.origin_name }}</v-card-title>
            <v-img :src="movie.movie.thumb_url" :lazy-src="movie.movie.thumb_url" height="70%" />
            <v-card-action class="mt-3 d-flex flex-column">
              <v-btn color="light-blue-darken-1" height="40" @click="loadMovie" class="mb-3">
                Play
              </v-btn>
