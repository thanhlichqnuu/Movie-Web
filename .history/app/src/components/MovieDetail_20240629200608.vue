...
.theme--light .background {
  opacity: 0.4 ; /* Set opacity for background in light theme */
  filter: none ; /* Ensure no filter is applied in light theme */
}

.theme--dark .background {
  opacity: 0.4 !important; /* Set opacity for background in dark theme */
  filter: none; /* Ensure no filter is applied in dark theme */
}
</style>
