    ...
    <v-card v-if="movie">
      <v-row>
        <v-col cols="12" class="background-container d-flex">
          <div class="background" :style="background" @load="backgroundLoaded.value = true"></div>
            ...
            <v-row :class="{ 'd-flex align-center flex-column': isSmallTabletAndMobile }">
              ...
              <v-col cols="12" sm="6">
                ...
                <v-list-item>
                  <v-row align="center">
                    <v-col cols="4" class="d-flex justify-end">
                      <v-list-item-title class="text-size">{{ $t("quality") }}</v-col>
                    <v-col cols="8" class="d-flex">
                      <v-list-item-subtitle class="text-size">{{
                        movie.movie.quality
                      }}</v-col>
...
.background-container::after {
  ...
  width: 100%;
  height: 100%;
  background: url('/path/to/placeholder-image.jpg') center/cover no-repeat;
  position: absolute;
  top: 0;
  left: 0;
  z-index: -2;
