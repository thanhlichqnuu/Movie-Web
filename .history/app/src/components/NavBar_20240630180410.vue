...
<template>
  <div>
    ...
    >
      ...
      <template v-if="!isTabletAndMobile">
        ...
        >
          <v-btn>$t('singlemovie></singlemovie>')</v-btn>
        </router-link>
        <router-link
  ...
  <v-btn v-show="$i18n.locale == 'EN'" @click="$i18n.locale = 'VI'"><img class="mr-1" src="../assets/flag_vi.png" height="20px" />VI</v-btn>  
  <v-btn v-show="$i18n.locale == 'VI'" @click="$i18n.locale = 'EN'"><img class="mr-1" src="../assets/flag_en.png" height="20px" />EN</v-btn>
    </v-app-bar>
