...
const api = ref(`https://apii.online/apii/danh-sach?type=hoathinh&page=${currentPage.value}&limit=12`)

const urls = computed(() => {
  let url = `https://apii.online/apii/danh-sach?type=hoathinh&page=${currentPage.value}&limit=12`;
