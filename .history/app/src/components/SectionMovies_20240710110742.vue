...
// Watch for data changes and update movies and totalPages
watch(data, (newData) => {
  if (newData) {
...
// Prefetch the next page if applicable
...
// Update currentPage on route query change
watch(
  () => route.query.page,
  (newPage) => {
...
// Push the new page number to the router
