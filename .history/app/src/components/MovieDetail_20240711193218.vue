...
<template>
  ...
  <v-col v-for="(episode, index) in movie.episodes[0].server_data.slice(-2)" :key="episode.slug" cols="4" class="d-flex justify-start">
    <v-btn size="small" class="ml-n5">{{ episode.name }}</v-btn>
  </v-col>
</v-row>
