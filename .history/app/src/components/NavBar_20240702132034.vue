  ...
  <div>
    ...
    >
      ...
      <router-link :to="{ name: 'Home' }" class="ml-3">
        <img src="../assets/logo.png" alt="logo" width="100px" height="auto" class="logo mt-1" />
      </router-link>
      ...
      <v-btn v-if="localeStore.locale === 'EN'" @click="changeLocale('VI')"><img class="mr-1" src="../assets/flag_en.png" alt="flag" width="auto" height="20px" />EN</v-btn>  
      <v-btn v-if="localeStore.locale === 'VI'" @click="changeLocale('EN')"><img class="mr-1" src="../assets/flag_vi.png" alt="flag" width="auto" height="20px" />VI</v-btn>
    </v-app-bar>
