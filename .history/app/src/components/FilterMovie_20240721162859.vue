  ...
  <v-main>
    ...
    <v-form @submit.prevent="applyFilter">
      ...
      <div class="button-group">
        <v-btn type="submit" color="red" class="mr-4">{{ t('filterButton') }}</v-btn>
        <v-btn @click="clearFilter" color="blue">{{ t('clearButton') }}</v-btn>
      </div>
    </v-form>
  </v-main>
</template>
...
import { genreOptions, statusOptions, countryOptions } from "@/util/filterCriteria.js";
