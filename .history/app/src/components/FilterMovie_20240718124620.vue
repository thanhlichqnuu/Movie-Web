...
const countryOptions = [
  ...
  { value: "sec", text: "Séc" },
  { value: "hong-kon", text: "Hong Kon" },
  { value: "uae", text: "UAE" },
  { value: "hoa-ky", text: "Hoa Kỳ" },
  { value: "phapduc", text: "Pháp Đức" },
  ...
  { value: "thai-lanphap", text: "Thái Lan Pháp" },
...
const categoryOptions = [
  ...
  { value: "chuong-trinh-truyen-hinh", text: "Chương trình truyền hình" },
...
<template>
  <v-main>
    <div class="mb-2 mt-n2">
      <h3 class="d-flex justify-start animate-charcter">Filter</h3>
      <div class="line" />
    </div>
