    ...
    <v-card v-if="movie">
      <v-row>
        <v-col cols="12" class="background-container">
          ...
          <div class="content">
            <v-col cols="6" sm="4">
              <v-img :src="movie.movie.thumb_url" :lazy-src="movie.movie.thumb_url" />
            </v-col>
      ...
      <v-row>
        <v-col cols="12">
          <v-card-text>
            <v-row>
              <v-col cols="12" sm="6">
                <v-list-item v-for="(item, index) in movieDetailsLeft" :key="index">
              ...
              <v-col cols="12" sm="6">
                <v-list-item v-for="(item, index) in movieDetailsRight" :key="index">
                  <v-row class="d-flex align-center">
                    <v-col cols="4">
                      <v-list-item-title>{{ item.title }}</v-list-item-title>
                    </v-col>
