    ...
    <v-card v-if="movie">
      <v-row>
        <v-col cols="12" class="background-container d-flex">
          ...
          <v-col :cols="isSmallTabletAndMobile ? 12 : 6"
          :sm="isSmallTabletAndMobile ? undefined : 4"
          :class="isSmallTabletAndMobile ? 'd-flex flex-column' : 'd-flex justify-center align-center'">
          <v-img v-if="!isSmallTabletAndMobile" :src="movie.movie.thumb_url" height="70%" />
          </v-col>
          <v-col :cols="isSmallTabletAndMobile ? undefined : 6"
          :sm="isSmallTabletAndMobile ? undefined : 8"
          :class="isSmallTabletAndMobile ? undefined : 'd-flex flex-column justify-space-between'">
          <div :class="isSmallTabletAndMobile ? undefined : 'mt-11'">
                <v-card-title class="text_green text-h5">{{
                  movie.movie.name
                }}</v-card-title>
                <v-card-title :class="isSmallTabletAndMobile ? 'text-subtitle-1 mt-n3' : ''"></v-card-title>{
