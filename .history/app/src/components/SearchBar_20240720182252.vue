...
const startSound = new Audio('path/to/start-sound.mp3'); // Replace with your actual start sound file path
const endSound = new Audio('path/to/end-sound.mp3'); // Replace with your actual end sound file path
