  ...
  <div>
    ...
    >
      ...
      <v-btn v-show="localeStore.locale === 'EN'" @click="changeLocale('VI')">
        <img class="mr-1" src="../assets/flag_en.png" alt="flag" width="auto" height="20px" />EN
      </v-btn>  
      <v-btn v-show="localeStore.locale === 'VI'" @click="changeLocale('EN')">
        <img class="mr-1" src="../assets/flag_vi.png" alt="flag" width="auto" height="20px" />VI
      </v-btn>
    </v-app-bar>
    ...
    <v-navigation-drawer v-model="isShowDotMenu" app temporary>
      ...
      <v-list-item @click="toggleFilterModal">
    ...
    <v-dialog v-model="isShowFilterModal" max-width="600px">
      <v-card>
        ...
        <v-card-actions>
          <v-btn color="primary" @click="closeFilterModal">{{ $t('close') }}</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
  </div>
