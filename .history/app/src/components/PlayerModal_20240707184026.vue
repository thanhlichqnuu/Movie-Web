...
const setupPlayer = async () => {
  ...
  hls.on(Hls.Events.MANIFEST_PARSED, function (event, data) {
    ...
    // Cập nhật giao diện người dùng với các tùy chọn chất lượng
  ...
  function updateQualityOptions(qualities) {
    ...
    // Tạo các option mới cho từng cấp độ chất lượng
    ...
    // Xử lý sự kiện khi người dùng thay đổi chất lượng
  ...
  // Tạo player Artplayer sau khi m3u8 đã được load và cấu hình Hls.js
