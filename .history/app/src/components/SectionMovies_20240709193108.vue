...
const { data, error } = useSWRV(`https://ophim1.com/danh-sach/phim-moi-cap-nhat?page=${currentPage.value}`, fetcher) 
...
const prefetchNextPage = async (page) => {
  if (page < totalPages.value) {
    useSWRV(`https://ophim1.com/danh-sach/phim-moi-cap-nhat?page=${page + 1}`, fetcher, { revalidateOnFocus: false });
  }
};
