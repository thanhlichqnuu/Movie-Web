    ...
    <v-card v-if="movie">
      <v-row>
        <v-col cols="12" class="background-container d-flex">
          ...
          <v-col v-if="!isTablet" cols="6" sm="4" class="d-flex justify-center align-center">
            <v-img :src="movie.movie.thumb_url" :lazy-src="movie.movie.thumb_url" height="70%" />
          </v-col>

          <v-col :cols="isTablet ? 12 : 6" sm="8" class="d-flex flex-column justify-space-between">
            <div class="mt-11">
            ...
            <v-col v-if="isTablet" cols="12" class="d-flex justify-center align-center">
              <v-img :src="movie.movie.thumb_url" :lazy-src="movie.movie.thumb_url" height="70%" />
            </v-col>

            <v-card-action class="mb-15" :class="isTablet ? 'd-flex flex-column align-center' : ''">
              <v-btn color="light-blue-darken-1" height="40" @click="loadMovie" class="mr-3">
                Play
              </v-btn>
              <v-btn color="red-darken-1" height="40" @click="loadTrailer">
                Watch Trailer
              </v-btn>
            </v-card-action>
