...
watch(useLocaleStore.locale, () => {
  tabs.value = [
    { name: t('lastUpdate'), api: 'https://ophim1.com/danh-sach/phim-moi-cap-nhat?page=1' },
    { name: t('anime'), api: 'https://ophim1.com/v1/api/danh-sach/hoat-hinh?page=1' },
    { name: t('series'), api: 'https://ophim1.com/v1/api/danh-sach/phim-bo?page=1' },
    { name: t('movie'), api: 'https://ophim1.com/v1/api/danh-sach/phim-le?page=1' },
  ];
