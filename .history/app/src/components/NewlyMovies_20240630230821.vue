...
const movieLabel = computed(() => t('lastUpdateLabel'));
const seriesLabel = computed(() => t('lastUpdateLabel'));

const tabs = ref([
  { name: translateLabel, api: 'https://ophim1.com/danh-sach/phim-moi-cap-nhat?page=1' },
