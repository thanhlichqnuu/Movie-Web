...
<template>
  <v-container>
    <v-card v-if="movie">
      <v-row>
        <v-col cols="12" class="d-flex backgroud-container">
          <v-container class="background" :style="background"></v-container>
        ...
        <v-col cols="8" sm="8" class="d-flex flex-column justify-space-between">
          <div>
