...
<template>
  <v-container class="mt-5">
    ...
    <v-row>
      <v-col :cols="isSmallTabletAndMobile ? 12 : 7" class="mt-9">
        <div class="mb-4">
          <v-banner bg-color="#d43939" text="Server [NC] VIETSUB #1 hay gặp lỗi! Vui lòng đổi sang server khác để có trải nghiệm tốt nhất">
      </v-banner>
        </div>
