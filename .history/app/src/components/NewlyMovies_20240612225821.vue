...
const tabs = ref([
  { name: 'Mới cập nhật', api: 'https://ophim1.com/danh-sach/phim-moi-cap-nhat?page=1', isActive: true },
  { name: 'Anime', api: 'https://ophim1.com/v1/api/danh-sach/hoat-hinh?page=1', isActive: false },
  { name: 'Series', api: 'https://ophim1.com/v1/api/danh-sach/phim-bo?page=1', isActive: false },
  { name: 'Movie', api: 'https://ophim1.com/v1/api/danh-sach/phim-le?page=1', isActive: false },
]);
...
.tab-active {
  color: green !important; /* Chỉnh màu cho tab hiện tại */
}
</style>
