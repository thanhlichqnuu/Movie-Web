...
const isSmallTabletAndMobile = computed(() => windowWidth.value < 1024);
...
<template>
  <div>
    ...
    >
      ...
      <v-btn v-show="localeStore.locale == 'EN'" @click="changeLocale('VI')"><img class="mr-1" src="../assets/flag_en.png" height="20px" />EN</v-btn>  
      <v-btn v-show="localeStore.locale == 'VI'" @click="changeLocale('EN')"><img class="mr-1" src="../assets/flag_vi.png" height="20px" />VI</v-btn>
    </v-app-bar>
